                      ...
                      children: <Widget>[
                        SizedBox(
                          ...
                          child: notes.isEmpty
                              ...
                              : RefreshIndicator(onRefresh: getRegisters, child: ListView(children: divided)),
                        ),
                        SizedBox(
                          height: 30,
                        ),
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  Text(
                                      "Total Crédito: R\$ ${currencyPattern(totalCredito.toString())}",
                                      style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          color: Colors.white,
                                          fontSize: 22)),
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  Text(
                                      "${totalAgregado >= 0 ? 'Saldo' : 'Déficit'}: R\$ ${currencyPattern(totalAgregado.toString())}",
                                      style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 22,
                                          color: Colors.white))
